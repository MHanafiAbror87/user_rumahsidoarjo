...
class Detail_Slb extends StatefulWidget {
  final SekolahData sekolah;
  Detail_Slb({required this.sekolah});

  @override
  _Detail_SlbState createState() => _Detail_SlbState();
}

class _Detail_SlbState extends State<Detail_Slb> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: FutureBuilder<DetailSekolahModel>(
          future: api.getSlbById(widget.sekolah.idSekolah),
