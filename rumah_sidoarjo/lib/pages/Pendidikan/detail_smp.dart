...
class Detail_Smp extends StatefulWidget {
  final SekolahData sekolah;
  Detail_Smp({required this.sekolah});

  @override
  _Detail_SmpState createState() => _Detail_SmpState();
}

class _Detail_SmpState extends State<Detail_Smp> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: FutureBuilder<DetailSekolahModel>(
          future: api.getSmpById(widget.sekolah.idSekolah),
